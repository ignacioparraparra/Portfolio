            ...
            <div className="Project-row">
                <div className="Project-card">
                    <div className="Project-card-box">
                      ...
                      <i>Nodejs, MongoDB, Express, Token Authentication,Upstart API, Arcjet API, Git, Postman, Nodemailer</i>
                      <h2>Highlevel Overview</h2>
                      <p>Let users create subscriptions, then autocalculate renewal date and send email reminders.</p>
                      <h2>Key Implementations</h2>
                      <p>+ Implemented token authentication with access & refresh tokens through middleware, controllers, and routes to secure API
                          requests and protect user data. Tested endpoints and cookie-based flows with Postman to validate request handling.</p>
                      <p>+ Configured Arcjet API as a rate limiter and bot protection tool to prevent abuse and improve system reliability.</p>
                      <p>+ Managed version control with Git and structured MongoDB schemas to maintain user/subscription data.</p>
                      <p>+ Established Upstash workflows with Nodemailer transporter to automate reminder emails based on subscription renewal dates,
                          increasing user engagement.</p>
                    </div>
                    <svg className="icons" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="70" viewBox="0 0 24 24">
                    <a href="https://github.com/ignacioparraparra/subscription-tracker" target="_blank">
                ...
                <div className="Project-card">
                     <img src="subtrackAPI.PNG" height="500"></img>
                </div>
            </div>
